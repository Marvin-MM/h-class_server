...
import { AppError, ValidationError, NotFoundError, ConflictError } from '../shared/errors/index.js';
...
export function errorHandler(err: Error, req: Request, res: Response, _next: NextFunction): void {
  ...
  if (err instanceof Prisma.PrismaClientKnownRequestError) {
    ...
    sendError(res, converted.statusCode, converted.errorCode, converted.message);
    return;
  }
 ...
 */
function convertPrismaError(error: Prisma.PrismaClientKnownRequestError): AppError {
  switch (error.code) {
    case 'P2002': {
    ...
    default: {
      return new AppError(`Database error: ${error.message}`, 500, 'DATABASE_ERROR', false);
    }
  }
}
